...
bool TextureEditPanel::Draw(Textures& testTexture, RenderFace* activeFace, RenderMesh* activeMesh, bool snapToGrid, float& textureScale, RenderMesh& outSnapBefore, ImVec2& outMinUV, ImVec2& outMaxUV) {
